...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.smallBusinessRadioButton.setText(_translate("MainWindow", "Small (< 10)"))
        self.mediumBusinessRadioButton.setText(_translate("MainWindow", "Medium (10-100)"))
        self.largeBusinessRadioButton.setText(_translate("MainWindow", "Large (> 100 )"))
        self.inputFilePermanentLabel.setText(_translate("MainWindow", "Input File:"))
        self.businessSizeLabel.setText(_translate("MainWindow", "Business Size (in number of nodes):"))
