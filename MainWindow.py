...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.inputFileButtonVLayout = QtWidgets.QVBoxLayout(
        ...
        self.inputFileButtonVLayout.addWidget(
            self.inputFileButton, 0, QtCore.Qt.AlignTop)
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget_2.setGeometry(
            QtCore.QRect(120, 110, 661, 41))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.fileNameLabelVLayout = QtWidgets.QVBoxLayout(
        ...
        self.fileNameLabelVLayout.addWidget(
            self.fileNameLabel, 0, QtCore.Qt.AlignTop)
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget_3.setGeometry(
            QtCore.QRect(300, 470, 251, 81))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.runScanButtonVLayout = QtWidgets.QVBoxLayout(
        ...
        self.programNameHLayout = QtWidgets.QHBoxLayout(
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(20, 200, 174, 81))
        self.verticalLayoutWidget_4.setObjectName("verticalLayoutWidget_4")
        self.businessSizeButtonVLayout = QtWidgets.QVBoxLayout(
            self.verticalLayoutWidget_4)
        self.businessSizeButtonVLayout.setContentsMargins(0, 0, 0, 0)
        self.businessSizeButtonVLayout.setObjectName(
            "businessSizeButtonVLayout")
        self.smallBusinessRadioButton = QtWidgets.QRadioButton(
            self.verticalLayoutWidget_4)
        ...
        self.mediumBusinessRadioButton = QtWidgets.QRadioButton(
            self.verticalLayoutWidget_4)
        self.mediumBusinessRadioButton.setObjectName(
            "mediumBusinessRadioButton")
        self.businessSizeButtonVLayout.addWidget(
            self.mediumBusinessRadioButton)
        self.largeBusinessRadioButton = QtWidgets.QRadioButton(
            self.verticalLayoutWidget_4)
        ...
        self.inputFilePermanentVLayout = QtWidgets.QVBoxLayout(
            self.verticalLayoutWidget_5)
        self.inputFilePermanentVLayout.setContentsMargins(0, 0, 0, 0)
        self.inputFilePermanentVLayout.setObjectName(
            "inputFilePermanentVLayout")
        self.inputFilePermanentLabel = QtWidgets.QLabel(
            self.verticalLayoutWidget_5)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.businessSizeLabelVLayout = QtWidgets.QVBoxLayout(
        ...
        self.businessTypeLabelVLayout = QtWidgets.QVBoxLayout(
        ...
        self.businessTypeButtonVLayout = QtWidgets.QVBoxLayout(
            self.verticalLayoutWidget_8)
        self.businessTypeButtonVLayout.setContentsMargins(0, 0, 0, 0)
        self.businessTypeButtonVLayout.setObjectName(
            "businessTypeButtonVLayout")
        self.homeSmallOfficeRadioButton = QtWidgets.QRadioButton(
            self.verticalLayoutWidget_8)
        self.homeSmallOfficeRadioButton.setObjectName(
            "homeSmallOfficeRadioButton")
        self.businessTypeButtonVLayout.addWidget(
            self.homeSmallOfficeRadioButton)
        self.corporateBusinessRadioButton = QtWidgets.QRadioButton(
            self.verticalLayoutWidget_8)
        self.corporateBusinessRadioButton.setObjectName(
            "corporateBusinessRadioButton")
        self.businessTypeButtonVLayout.addWidget(
            self.corporateBusinessRadioButton)
        self.federalBusinessRadioButton = QtWidgets.QRadioButton(
            self.verticalLayoutWidget_8)
        self.federalBusinessRadioButton.setObjectName(
            "federalBusinessRadioButton")
        self.businessTypeButtonVLayout.addWidget(
            self.federalBusinessRadioButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate(
            "MainWindow", "Cost-Benefit Analysis Tool"))
        self.inputFileButton.setText(
            _translate("MainWindow", "Select Input File"))
        self.runScanButton.setText(_translate("MainWindow", "Run Scan"))
        self.programNameLabel.setText(_translate(
            "MainWindow", "Cost-Benefit Analysis Tool"))
        self.smallBusinessRadioButton.setText(
            _translate("MainWindow", "Small (< 10)"))
        self.mediumBusinessRadioButton.setText(
            _translate("MainWindow", "Medium (10-100)"))
        self.largeBusinessRadioButton.setText(
            _translate("MainWindow", "Large (> 100 )"))
        self.inputFilePermanentLabel.setText(
            _translate("MainWindow", "Input File:"))
        self.businessSizeLabel.setText(_translate(
            "MainWindow", "Business Size (in number of nodes):"))
        self.businessTypeLabel.setText(
            _translate("MainWindow", "Business Type:"))
        self.homeSmallOfficeRadioButton.setText(
            _translate("MainWindow", "Home/ Small Office"))
        self.corporateBusinessRadioButton.setText(
            _translate("MainWindow", "Corporate"))
        self.federalBusinessRadioButton.setText(
            _translate("MainWindow", "Federal/Govermental"))
        ...
        self.aboutProgramTabPress.setText(
            _translate("MainWindow", "About Program"))
