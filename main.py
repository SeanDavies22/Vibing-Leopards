...
class MainGUI(QtWidgets.QMainWindow):
    ...
    def main(self):
        ...
        self.ui.smallBusinessRadioButton.pressed.connect(self.small_business_radio_button_action_handling)
        self.ui.mediumBusinessRadioButton.pressed.connect(self.medium_business_radio_button_action_handling)
        self.ui.largeBusinessRadioButton.pressed.connect(self.large_business_radio_button_action_handling)

        self.ui.homeSmallOfficeRadioButton.pressed.connect(self.small_home_office_business_action_handling)
        self.ui.corporateBusinessRadioButton.pressed.connect(self.corporate_office_business_action_handling)
        self.ui.federalBusinessRadioButton.pressed.connect(self.federal_office_business_action_handling)
    ...
    def run_scan_button_action_handling(self):
        ...
        if (self.businessSize == 0):
            self.show_error_pop_up("No business size selected. Please select a business size.")
        if (self.businessType == 0):
            self.show_error_pop_up("No business type selected. Please select a business type.")
